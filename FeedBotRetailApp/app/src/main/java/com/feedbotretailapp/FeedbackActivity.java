                ...
                public void run() {
                  ...
                  //  postParameters.add(new BasicNameValuePair("mobile", mobNo));
                    ...
                    try {
                        ...
                        QLISTJSON=json.getJSONArray("QueryList");
                        QOPTIONJSON=json.getJSONArray("QueryType");
                        QFOCUSKEYWORDJSON=json.getJSONArray("FocusKeyword");
...
*/
            ...
            try {
                ...
                if (resp.equals("success")) {
                    ...
                    editor.putString(QS, QLISTJSON.toString());
                    editor.putString(QT, QOPTIONJSON.toString());
                    editor.putString(QFK, QFOCUSKEYWORDJSON.toString());
